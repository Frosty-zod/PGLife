...
class App extends Component {
  ...
  render() {
    ...
    if (this.state.filter.budget !== "none") {
      properties = properties.filter(property => {
        if (this.state.filter.budget === "under5k") return property.rent < 5000;
        if (this.state.filter.budget === "5to10k") return property.rent >= 5000 && property.rent <= 10000;
        if (this.state.filter.budget === "above10k") return property.rent > 10000;
        return true;
      });
    }
